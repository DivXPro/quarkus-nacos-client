...
public class Configuration {
    private static final Logger log = org.jboss.logging.Logger.getLogger(Configuration.class);
    ...
    private static Map<String, String> yamlStringToMap(String str) {
        ...
        HashMap<String, Object> yamlInput = new Yaml().loadAs(str, HashMap.class);
